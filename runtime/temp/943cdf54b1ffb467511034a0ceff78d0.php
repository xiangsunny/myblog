<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:62:"F:\tp5\tp5.0\public/../application/admin\view\login\login.html";i:1546951576;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
  ...
  <body>
    <div class="container">
      <form class="form-signin" action="<?php echo url('check'); ?>" method="post">
        ...
        <div class="checkbox">
          <label>
	       ...
	       输入验证码：<INPUT type="text" class="text" name="code" value=''><br/>
