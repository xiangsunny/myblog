<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:62:"F:\tp5\tp5.0\public/../application/admin\view\admin\index.html";i:1545965961;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
  ...
  <body>
    <div class="container">
      ...
      <form class="form-signin" action="<?php echo url('admin'); ?>" method="post">
